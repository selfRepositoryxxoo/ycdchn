...
/**
 * 防止XFS攻击js 使用js把iframe remove掉
 *
 * 所以防止恶心的第三方提供商对页面进行XFS共计
 * */
    ...
    if (!(/micromessenger/i.test(navigator.userAgent))) {
        try {
            ...
            /*
             ...
             var ownerHref = window.location.href;
             if(parentHref != ownerHref){
             window.top.location.href = ownerHref;
             }
             */
        } catch (e) {
            console.log('remove iframe error');
        }
    }
});
