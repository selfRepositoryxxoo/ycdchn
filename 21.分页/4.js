    ...
    function (AlbumNew , Confirm) {
        ...
        Album.prototype = {
                        ...
                        success:function(data){
                            laypage({
                                ...
                                jump: function(obj){//点击之后 回调
                                    edit.innerHTML = this.thisDate(data);
                                    load(obj.curr);
                                    this.dbClick()
                                }
                            });
            ...
            dbClick:function(){
                ...
                var span_block=$('.span_block'),
                    input_block=$('.input_block');
                span_block.each(function (index, item) {
                    $(item).dblclick(function () {
                        $(item).css({
                            'display': 'none'
                        });
                        $(item).next('.input_block').css({
                            'display': 'inline-block'
                        });
                    })
                });
                input_block.each(function (index, item) {
                    $(item).blur(function () {
                        var val = item.value;
                        $(item).prev('.span_block').css({
                            'display': 'inline-block'
                        });
                        $(item).css({
                            'display': 'none'
                        })
                        $(item).prev('.span_block').html(val)
                    });
